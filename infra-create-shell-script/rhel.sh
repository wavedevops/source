...
# # Example usage: print the subnet ID for us-east-1a
# # echo "Subnet for us-east-1a: $SUBNET_US_EAST_1A"
# # echo "Subnet for us-east-1b: $SUBNET_US_EAST_1B"
# # echo "Subnet for us-east-1c: $SUBNET_US_EAST_1C"
# # echo "Subnet for us-east-1d: $SUBNET_US_EAST_1D"
# # echo "Subnet for us-east-1e: $SUBNET_US_EAST_1E"
# # echo "Subnet for us-east-1f: $SUBNET_US_EAST_1F"
